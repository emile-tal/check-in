    ...
    return (
        <div className='help-modal'>
            ...
            <p className='help-modal__text'>
                Each turn, you will take place a room tile adjacent to your placed tiles as you build up your hotel empire. There are 7 types of room tiles you can place:
            </p>
